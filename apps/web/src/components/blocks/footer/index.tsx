...
function FooterColumns({ content, className }: FooterVariantProps) {
  ...
  return (
    <footer className={cn("bg-[var(--color-secondary)] text-white", className)}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            {content.tagline && (
              <p className="text-white/70 text-sm">{content.tagline}</p>
            )}
...
function FooterCentered({ content, className }: FooterVariantProps) {
  ...
  return (
    <footer className={cn("bg-[var(--color-surface)]", className)}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="py-12 border-b border-white/10">
            <div className="max-w-xl mx-auto text-center">
              ...
              <form className="flex gap-2" onSubmit={(e) => e.preventDefault()}>
                ...
                <button
                  type="submit"
                  className="px-6 py-3 bg-white text-[var(--color-secondary)] font-medium rounded-lg hover:bg-white/90 transition-colors"
                >
        ...
        <div className="py-12 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8">
          ...
          <div className="col-span-2">
            ...
            {content.tagline && (
              <p className="text-white/70 text-sm mb-4">{content.tagline}</p>
            )}
            {content.socialLinks && content.socialLinks.length > 0 && (
              <div className="flex gap-4">
                {content.socialLinks.map((link, index) => (
